...
prefixed by "Over 30:" in bold, the values ​​of the Thirty array should be prefixed by "Under 30:" in bold,
...
the first parameters depending on what the third parameter is set to ("add", "subtract", "multiply", "divide").
When the result has been calculated, this should be displayed in an alert box.

In addition, before the calculation is made, check that arguments 1 and 2 are set to numbers
and that argument number three is either set to "add", "subtract", "multiply" or "divide",
if any of these conditions are not met, display an alert box with the text "Something is wrong"
*/
...
function taskTen () {
  // the first and second arguments should be numbers, the third argument should be
  // be a string with any of the values ​​"add", "subtract", "multiply", "divide"
  calculator ();
}